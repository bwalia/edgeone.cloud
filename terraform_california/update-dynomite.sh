...
TARGET=$(</Users/balinderwalia/Documents/Work/edgeone/terraform_singapore/public_ips.txt)

if [ -z ${REMOTE_POP_REDIS_IP} ];
then
    REMOTE_POP_REDIS_IP=$(</Users/balinderwalia/Documents/Work/edgeone/terraform/public_ips.txt)
fi
