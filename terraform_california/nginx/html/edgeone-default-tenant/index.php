...
<html>
<head>
<title>Welcome to edgeone.co.uk PHP Web Server</title>
<style>
    body {
        width: 35em;
        margin: 0 auto;
...
<body>
<br/><br/><br/><br/>
<h2>Welcome to EdgeOne PHP Web Server.</h2>
<p>If you see this page, the EdgeOne Web Server software platform is successfully installed and working. </p>
<p>EdgeOne PHP Web server is built on top of Nginx/Openresty/PHP7 with automation in mind! It has built in REST API for adding nginx server blocks configuration for each tenant easily and dynamically without any downtime.</p>
<?php
